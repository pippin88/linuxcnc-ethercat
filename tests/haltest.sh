...
echo "... checking D17 cross-connect"
set-pin D17 dout-0 true
test-pin-true D17 din-0
test-all-din-true-count 1
set-pin D17 dout-0 false
test-all-din-false

echo "... checking D17 to D1"
set-pin D17 dout-6 true
test-pin-true D1 din-7
test-all-din-true-count 1
set-pin D17 dout-6 false
test-all-din-false

echo "... checking D17 to D2"
set-pin D17 dout-7 true
test-pin-true D2 din-7
test-all-din-true-count 1
set-pin D17 dout-7 false
test-all-din-false
